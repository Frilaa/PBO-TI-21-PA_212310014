...
public class Latihan01 extends JFrame {
	...
	public Latihan01() {
		...
		final JButton button_Hello = new JButton("أهلا");
		button_Hello.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseClicked(MouseEvent e) {
				JOptionPane jop = new JOptionPane();
				
				jop.showMessageDialog(null, "أهلا is a word for 'Hello' " ,"You Just Clicked " + button_Hello.getText(), jop.INFORMATION_MESSAGE);
			}
		});
